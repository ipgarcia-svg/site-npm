...
- Fixed the spelling of André Manzoli's name across the site — no accent ("Andre"), matching the CNPJ registry — corrected in 10 pages (title, hero, portrait alt text, team cards).
...
- Fixed a redundancy introduced in the previous commit: André Manzoli, Thaís Vilhena and Tathiana Fiuza's opening bio paragraphs already had their CESA committee stated in a fuller credentials sentence further down the same page — the one-liner I'd just added was a pure duplicate (frase-eco). Reverted those three. Fabio Plantulli and Luiz Novaes kept only the genuinely new fact (Anuário CESA 2025 authorship), dropping the CBAr/Diretoria clause that duplicated what the page already stated.
